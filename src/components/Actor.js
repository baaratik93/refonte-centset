      ...
      <ModalOverlay>
          <ModalContent>
              ...
              <ModalBody display="flex" justifyContent="space-around">
                  <Image borderRadius={16}  src={props.image}/><Box><Text p={5}> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab eum autem perferendis velit commodi vero aliquam odit temporibus corporis alias.
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab eum autem perferendis velit commodi vero aliquam odit temporibr</Text></Box>
              </ModalBody>
              <ModalFooter>
